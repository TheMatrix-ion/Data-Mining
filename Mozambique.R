...
# Classification————Yaojie Zhang
# Load data
data <- read.csv("Mozambique_data.csv")
...
data$Event <- factor(data$Event, levels = c("ACCIDENT", "BIOLOGICAL", "CONFLICT MAN WILD FAUNA", 
                                            "CYCLONE", "DROUGHT", "EARTHQUAKE","EPIDEMIC" ,
                                            "EXPLOSION", "FIRE","FLASH FLOOD","FLOOD",
                                            "FOREST FIRE","HAILSTORM","HEAT WAVE","ALLUVION",
                                            "LANDSLIDE","LIGHTNING","OTHER","PLAGUE",
                                            "RAINS","STORM","STRONG WIND","SURGE",
                                            "THUNDER STORM","TROP. DEPRESS."))
